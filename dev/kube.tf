...
module "kube-hetzner" {
  ...
  # * Your ssh public key
  ssh_public_key = file("~/.ssh/gh-personal.pub")
  ...
  ssh_private_key = file("~/.ssh/gh-personal-private")
...
#
  ...
  firewall_kube_api_source = ["203.12.0.4/32", "0.0.0.0/0", "::/0"]
  ...
  firewall_ssh_source = ["203.12.0.4/32", "0.0.0.0/0", "::/0"]
